        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Beschrijving = table.Column<string>(type: "TEXT", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAfgemeld = table.Column<bool>(type: "INTEGER", nullable: false),
                    Aanmelding = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Afmelding = table.Column<DateTime>(type: "TEXT", nullable: false),
                    srcUserId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AanmeldingenClients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AanmeldingenClients_AspNetUsers_srcUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AanmeldingenClients_srcUserId",
                table: "AanmeldingenClients",
                column: "srcUserId");
