    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MijnContext>(o=>
                        o.UseSqlServer("Server=tcp:kinderpraktijkhij2.database.windows.net,1433;Initial Catalog=Product_db;Persist Security Info=False;User ID=KinderpraktijkHij;Password=J0eBiden!123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"));
            ...
            */
            services.AddCors(options=>
                options.AddDefaultPolicy(builder =>
                {
                    ...
                    builder.WithOrigins("https://JoeriOpdrachtStage.azurewebsites.net")
